...
export const about = {
   ...
   * that goes with it. Nothing was written for this structure; the story was
   * only divided where it already moves from one place to the next.
   */
  path: {
    stops: [
    ...
    beats: [
      {
        ...
        figure: "contours",
        lead: true,
        text: "I came into software from a completely different path.",
      },
      {
        stops: [1],
        figure: "parcels",
